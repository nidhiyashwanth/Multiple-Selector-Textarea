...
2. Then, paste code from `MultipleTextAreaSelector` component, alternatively you can use `MultipleSelectorCreatable` component inside `src/components/ui/common/MultipleSelectorCreatable.tsx`:
